...
### Indicates that you're developing lib_xs3_math in this build
## Iff enabled, the unit tests and examples will also be built.
set(DEV_LIB_XS3_MATH OFF CACHE BOOL "Include unit tests and examples as CMake Targets." )
...
set( XS3_MATH_USE_DEFAULT_FFT_LUT  ON CACHE BOOL "Use default provided FFT look-up table. (ignored if GEN_FFT_LUT is enabled)." )

## The maximum FFT length supported by the LUT (log2)
set( XS3_MATH_MAX_FFT_LEN_LOG2 "10" CACHE STRING "Maximum FFT length to be supported by generated look-up tables. Must be a positive integer." )