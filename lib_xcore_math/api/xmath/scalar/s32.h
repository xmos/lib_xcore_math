 ...
 *
 * If the result does not fit in 32 bit integer format, it's saturated to INT32_MAX/INT32_MIN.
 *
 ...
 *
 * If the result does not fit in 32 bit unsigned format, it's saturated to UINT32_MAX.
 *
 * @param[in]   x       64 bit unsigned integer dividend
 * @param[in]   y       32 bit unsigned divisor
 *
