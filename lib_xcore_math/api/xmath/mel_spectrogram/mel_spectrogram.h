 ...
 * "small" and "large".
 *
 * In "small" operation, the function expects @p in to be of form int16_t[6400]
 * and @p out to be of the form int8_t[1][64][26][4]. It will process the input
 ...
 *
 * In "large" operation, the function expects @p in to be of the form
 * int16_t[84800] and @p out to be of the form int8_t[1][128][158][4]. It will
 ...
 * int8_t out[] = 0.003921553026884794 * (output + 128) for all output, 
 ...
 * /p out is edited in place, and is not safe to access during operation
 * /p in is accessed in place, and is not safe to access during operation
 *
 ...
 *
 * @param[out] out - Output. Takes a pointer to int8_t[1][n_mels][n_frames][4],
 ...
 * @param[in] in   - Input vector. Takes a pointer to int16_t[n_samples], where
