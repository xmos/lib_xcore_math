 ...
 * Output values saturate to the 16-bit integer range (see @ref note_vpu_saturation for
 * architecture-specific saturation bounds). To avoid saturation, `b_shl` should be no greater than the headroom of `b` (`b->hr`).
 *
 * @operation{
