...
/**
 * @page page_dct_h  dct.h
 * 
 * This header contains functions for performing forward and inverse Discrete Cosine Transforms 
 * (DCTs) on 32-bit vectors of various sizes.
 * 
 * @note This header is included automatically through `xs3_math.h` or `bfp_math.h`.
 * 
 * @ingroup xs3_math_header_file
 * 
 * @defgroup dct_func   XS3 DCT Functions
 */
 ...
 * @param[out]  x   Input vector @vector{x}
 * 
