 ...
 * 
 * The exponent returned, if used with `xs3_vect_f32_to_s32()`, is the one which will result in
 ...
 * 
 * @see xs3_vect_f32_to_s32
 * @see xs3_vect_s32_to_f32
 * 
 ...
 * 
 * The function `xs3_vect_f32_max_exponent()` can be used to determine the value for @math{a\_exp}
