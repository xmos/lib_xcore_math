 ...
 *
 * The function xs3_vect_s16_add_scalar_prepare() can be used to obtain values for @math{a\_exp},
 * @math{b\_shr} and @math{c\_shr} based on the input exponents @math{b\_exp} and @math{c\_exp} and the input headrooms @math{b\_hr} and @math{c\_hr}.
 *
 * Note that @math{c\_shr} is an output of `xs3_vect_s16_add_scalar_prepare()`, but is not a
 * parameter to this function. The @math{c\_shr} produced by `xs3_vect_s16_add_scalar_prepare()` is
 ...
 * @exception ET_LOAD_STORE Raised if `a` or `b` is not word-aligned (See @ref note_vector_alignment)
 * 
 * @see xs3_vect_s16_add_scalar_prepare()
 * 
 * @ingroup xs3_vect16_func
 */
C_API
...
/**
 * @brief Obtain the output exponent and shifts required for a call to `xs3_vect_s16_add_scalar()`.
 * 
 * The logic for computing the shifts and exponents of `xs3_vect_s16_add_scalar()` is identical to
