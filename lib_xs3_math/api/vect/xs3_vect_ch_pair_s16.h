...
/**
 * @page page_xs3_vect_ch_pair_s16_h  xs3_vect_ch_pair_s16.h
 * 
 * This header contains functions implementing arithmetic operations on 16-bit channel-pair vectors, 
