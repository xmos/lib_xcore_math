 ...
 *
 * The function xs3_vect_complex_s16_add_scalar_prepare() can be used to obtain values for
 ...
 *
 * Note that @math{c\_shr} is an output of `xs3_vect_complex_s16_add_scalar_prepare()`, but is not a
 * parameter to this function. The @math{c\_shr} produced by
 * `xs3_vect_complex_s16_add_scalar_prepare()` is to be applied by the user, and the result passed
 * as input `c`.
 * @endparblock
 * 
 * @param[out]      a_real      Real part of complex output vector @vector{a}
 ...
 * 
 * @see xs3_vect_complex_s16_add_scalar_prepare
 * 
 * @ingroup xs3_vect16_func
 */
C_API
 ...
 * 
 * The logic for computing the shifts and exponents of `xs3_vect_complex_s16_add_scalar()` is
 * identical to that for `xs3_vect_s32_add()`.
 * 
 * This macro is provided as a convenience to developers and to make the code more readable.
 * 
