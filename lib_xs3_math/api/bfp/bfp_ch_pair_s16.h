...
/**
 * @page page_bfp_ch_pair_s16_h  bfp_ch_pair_s16.h
 * 
 * This header contains functions which operate on 16-bit block floating-point channel pair vectors.
 * 
