...
/**
 * @page page_bfp_ch_pair_s32_h  bfp_ch_pair_s32.h
 * 
 * This header contains functions which operate on 32-bit block floating-point channel pair vectors.
 * 
