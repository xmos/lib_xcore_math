...
/**
 * @page page_bfp_complex_s16_h  bfp_complex_s16.h
 *
 * This header contains functions implementing arithmetic operations on 16-bit complex block
