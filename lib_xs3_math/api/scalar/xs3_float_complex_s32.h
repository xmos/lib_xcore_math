...
/**
 * @page page_xs3_float_complex_s32_h  xs3_float_complex_s32.h
 * 
...
/**
 * @defgroup xs3_float_complex_s32_funcs   Scalar floating-point functions
 */
 ...
 * 
 * @ingroup xs3_float_complex_s32_funcs
 */
C_API
