 ...
 * 
 * Comparison to xs3_q24_logistics_fast():
 *                                  Time           Max Observed Error
 *    xs3_q24_logistics              10t                 36
 *    xs3_q24_logistics_fast          t                110280
 * 
 */ 
    ...
    const q8_24 x)
{
  ...
  if(pos_x <= Q24(1.2)){
    ...
    xs3_s32_odd_powers(odd_powers, pos_x, 7, 24);
    result += xs3_chunk_s32_dot(&odd_powers[0], &logi_ps_coef[1]);
    ...
    float_s32_t yy = xs3_float_s32_exp(xx);
