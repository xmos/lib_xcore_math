    ...
    const int32_t dct_lut[])
{
  ...
  return MIN(xs3_vect_s32_headroom(sums, length), 
             xs3_vect_s32_headroom(diffs, length));
}

void xs3_dct_deconvolve_s32(
    int32_t res[],
    const int32_t B[],
    const int32_t D[],
