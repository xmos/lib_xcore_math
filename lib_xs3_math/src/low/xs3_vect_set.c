...
void xs3_set_vect_complex_s16(
    ...
    const unsigned length)
{
    xs3_set_vect_s16(real, real_value, length);
    xs3_set_vect_s16(imag, imag_value, length);
}
    ...
    const unsigned length)
{
    ...
    xs3_set_vect_s32((int32_t*) data, tmp.s32, length);
}
...
void xs3_set_vect_ch_pair_s32(
    ...
    const unsigned length)
{
    xs3_set_vect_complex_s32((complex_s32_t*) data, ch_a, ch_b, length);
}