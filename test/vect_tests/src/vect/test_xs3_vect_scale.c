...
TEST_GROUP_RUNNER(xs3_vect_scale) {
  RUN_TEST_CASE(xs3_vect_scale, xs3_vect_s16_scale_prepare);
  RUN_TEST_CASE(xs3_vect_scale, xs3_vect_s16_scale_basic);
  RUN_TEST_CASE(xs3_vect_scale, xs3_vect_s16_scale_random);
  RUN_TEST_CASE(xs3_vect_scale, xs3_vect_s32_scale_basic);
  RUN_TEST_CASE(xs3_vect_scale, xs3_vect_s32_scale_random);
}
...
TEST(xs3_vect_scale, xs3_vect_s16_scale_basic)
{
...
TEST(xs3_vect_scale, xs3_vect_s16_scale_random)
{
...
TEST(xs3_vect_scale, xs3_vect_s32_scale_basic)
{
...
TEST(xs3_vect_scale, xs3_vect_s32_scale_random)
{
