...
TEST_GROUP_RUNNER(xs3_vect_mul) {
  ...
  RUN_TEST_CASE(xs3_vect_mul, xs3_vect_s32_mul_prepare);
  RUN_TEST_CASE(xs3_vect_mul, xs3_vect_s16_mul_basic);
  RUN_TEST_CASE(xs3_vect_mul, xs3_vect_s16_mul_random);
  RUN_TEST_CASE(xs3_vect_mul, xs3_vect_s32_mul_basic);
