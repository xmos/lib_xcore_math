...
static void test_xs3_vect_s32_macc_alt()
{
    printf("%s...\n", __func__);
    ...
    for(int v = 0; v < REPS; v++){
        ...
        xs3_vect_s32_macc_alt_prepare(&exp.a, &acc_shr, &b_shr, &c_shr, 
                                              exp.a, exp.b, exp.c, 
                                              hr.a, hr.b, hr.c);

        hr.a = xs3_vect_s32_macc_alt(A, B, C, LEN, acc_shr, b_shr, c_shr);
...
void test_xs3_macc_vect()
{
    ...
    RUN_TEST(test_xs3_vect_s32_macc_alt);
}
