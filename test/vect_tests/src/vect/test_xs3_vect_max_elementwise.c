...
TEST_GROUP(xs3_vect_max_elementwise);
TEST_SETUP(xs3_vect_max_elementwise) { fflush(stdout); }
TEST_TEAR_DOWN(xs3_vect_max_elementwise) {}

TEST_GROUP_RUNNER(xs3_vect_max_elementwise) {
  RUN_TEST_CASE(xs3_vect_max_elementwise, xs3_vect_s16_max_elementwise);
  RUN_TEST_CASE(xs3_vect_max_elementwise, xs3_vect_s32_max_elementwise);
}

static int16_t max_s16(int16_t b, int16_t c, right_shift_t b_shr, right_shift_t c_shr)
{
  b = vlashr16(b, b_shr);
  c = vlashr16(c, c_shr);
  return (b >= c)? b : c;
...
static int32_t max_s32(int32_t b, int32_t c, right_shift_t b_shr, right_shift_t c_shr)
{
  b = vlashr32(b, b_shr);
  c = vlashr32(c, c_shr);
  return (b >= c)? b : c;
...
TEST(xs3_vect_max_elementwise, xs3_vect_s16_max_elementwise)
{
    ...
    for(int v = 0; v < REPS; v++){
        ...
        // Not in-place
        hr = xs3_vect_s16_max_elementwise(A, B, C, len, b_shr, c_shr);
        ...
        hr = xs3_vect_s16_max_elementwise(A, A, C, len, b_shr, c_shr);
...
TEST(xs3_vect_max_elementwise, xs3_vect_s32_max_elementwise)
{
    unsigned seed = SEED_FROM_FUNC_NAME();
    ...
    for(int v = 0; v < REPS; v++){
        ...
        // Not in-place
        hr = xs3_vect_s32_max_elementwise(A, B, C, len, b_shr, c_shr);
        ...
        // In-place arg-2
        memcpy(A, B, sizeof(A[0])*len);
        hr = xs3_vect_s32_max_elementwise(A, A, C, len, b_shr, c_shr);
