...
TEST_GROUP_RUNNER(xs3_vect_log) {
  RUN_TEST_CASE(xs3_vect_log, xs3_chunk_s32_log_correctness);
  RUN_TEST_CASE(xs3_vect_log, xs3_chunk_s32_log);
  RUN_TEST_CASE(xs3_vect_log, xs3_chunk_float_s32_log_CORRECTNESS);
  RUN_TEST_CASE(xs3_vect_log, xs3_chunk_float_s32_log_RANDOM);
  RUN_TEST_CASE(xs3_vect_log, xs3_vect_float_s32_log);
  RUN_TEST_CASE(xs3_vect_log, xs3_vect_s32_log);
}

TEST_GROUP(xs3_vect_log);
TEST_SETUP(xs3_vect_log) { fflush(stdout); }
TEST_TEAR_DOWN(xs3_vect_log) {}
...
TEST(xs3_vect_log, xs3_chunk_float_s32_log_RANDOM)
{
  unsigned seed = SEED_FROM_FUNC_NAME();
...
TEST(xs3_vect_log, xs3_chunk_s32_log)
{
  unsigned seed = SEED_FROM_FUNC_NAME();
...
TEST(xs3_vect_log, xs3_vect_s32_log)
{
  unsigned seed = SEED_FROM_FUNC_NAME();
  seed = 0x1DA79E33;
  // printf("\n");
  ...
  for(int v = 0; v < REPS; v++){
    ...
    switch(output_base){
      case 1:
        ...
        xs3_vect_s32_log(A, B, b_exp, length);
        t1 = get_reference_time();
        break;
      case 2:
        t0 = get_reference_time();
        xs3_vect_s32_log2(A, B, b_exp, length);
        t1 = get_reference_time();
        break;
      case 10:
        t0 = get_reference_time();
        xs3_vect_s32_log10(A, B, b_exp, length);
        t1 = get_reference_time();
        break;
      default:
        t0 = get_reference_time();
        xs3_vect_s32_log_base(A, B, b_exp, inv_ln_output_base_q30, length);
        t1 = get_reference_time();
    }
...
TEST(xs3_vect_log, xs3_vect_float_s32_log)
{
  unsigned seed = SEED_FROM_FUNC_NAME();
  ...
  for(int v = 0; v < REPS; v++){
    ...
    switch(output_base){
      case 1:
        t0 = get_reference_time();
        xs3_vect_float_s32_log(A, B, length);
        t1 = get_reference_time();
        break;
      case 2:
        t0 = get_reference_time();
        xs3_vect_float_s32_log2(A, B, length);
        t1 = get_reference_time();
        break;
      case 10:
        t0 = get_reference_time();
        xs3_vect_float_s32_log10(A, B, length);
        t1 = get_reference_time();
        break;
      default:
        t0 = get_reference_time();
        xs3_vect_float_s32_log_base(A, B, inv_ln_output_base_q30, length);
        t1 = get_reference_time();
    }
