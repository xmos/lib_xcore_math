...
TEST_GROUP_RUNNER(xs3_vect_complex_sub) {
  RUN_TEST_CASE(xs3_vect_complex_sub, xs3_vect_complex_s32_sub);
  RUN_TEST_CASE(xs3_vect_complex_sub, xs3_vect_complex_s16_sub);
}

TEST_GROUP(xs3_vect_complex_sub);
TEST_SETUP(xs3_vect_complex_sub) { fflush(stdout); }
TEST_TEAR_DOWN(xs3_vect_complex_sub) {}
...
TEST(xs3_vect_complex_sub, xs3_vect_complex_s16_sub)
{
...
TEST(xs3_vect_complex_sub, xs3_vect_complex_s32_sub)
{
