...
TEST_GROUP_RUNNER(xs3_vect_complex_add) {
  RUN_TEST_CASE(xs3_vect_complex_add, xs3_vect_complex_s32_add);
  RUN_TEST_CASE(xs3_vect_complex_add, xs3_vect_complex_s16_add);
}

TEST_GROUP(xs3_vect_complex_add);
TEST_SETUP(xs3_vect_complex_add) { fflush(stdout); }
...
TEST(xs3_vect_complex_add, xs3_vect_complex_s16_add)
{
...
TEST(xs3_vect_complex_add, xs3_vect_complex_s32_add)
{
