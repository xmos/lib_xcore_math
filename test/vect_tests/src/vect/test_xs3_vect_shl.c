...
TEST_GROUP_RUNNER(xs3_vect_shl) {
  RUN_TEST_CASE(xs3_vect_shl, xs3_vect_s16_shl_basic);
...
TEST_GROUP(xs3_vect_shl);
TEST_SETUP(xs3_vect_shl) { fflush(stdout); }
TEST_TEAR_DOWN(xs3_vect_shl) {}
...
TEST(xs3_vect_shl, xs3_vect_s16_shl_basic)
{
...
TEST(xs3_vect_shl, xs3_vect_s16_shl_random)
{
...
TEST(xs3_vect_shl, xs3_vect_s32_shl_basic)
{
...
TEST(xs3_vect_shl, xs3_vect_s32_shl_random)
{
...
TEST(xs3_vect_shl, xs3_vect_complex_s32_shl)
{
