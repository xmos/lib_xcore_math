...
TEST_SETUP(xs3_vect_clip) { fflush(stdout); }
TEST_TEAR_DOWN(xs3_vect_clip) {}
...
TEST(xs3_vect_clip, xs3_vect_s16_clip_basic) //
{
...
TEST(xs3_vect_clip, xs3_vect_s32_clip_basic)
{
