...
TEST_GROUP_RUNNER(xs3_vect_shr) {
  RUN_TEST_CASE(xs3_vect_shr, xs3_vect_s16_shr_basic);
  RUN_TEST_CASE(xs3_vect_shr, xs3_vect_s16_shr_random);
  RUN_TEST_CASE(xs3_vect_shr, xs3_vect_s32_shr_basic);
  RUN_TEST_CASE(xs3_vect_shr, xs3_vect_s32_shr_random);
  RUN_TEST_CASE(xs3_vect_shr, xs3_vect_ch_pair_s16_shr);
  RUN_TEST_CASE(xs3_vect_shr, xs3_vect_ch_pair_s32_shr);
...
TEST_SETUP(xs3_vect_shr) {}
TEST_TEAR_DOWN(xs3_vect_shr) {}
...
TEST(xs3_vect_shr, xs3_vect_s16_shr_basic)
{
...
TEST(xs3_vect_shr, xs3_vect_s16_shr_random)
{
...
TEST(xs3_vect_shr, xs3_vect_s32_shr_basic)
{
...
TEST(xs3_vect_shr, xs3_vect_s32_shr_random)
{
...
TEST(xs3_vect_shr, xs3_vect_ch_pair_s16_shr)
{
...
TEST(xs3_vect_shr, xs3_vect_ch_pair_s32_shr)
{
...
TEST(xs3_vect_shr, xs3_vect_complex_s16_shr)
{
...
TEST(xs3_vect_shr, xs3_vect_complex_s32_shr)
{
