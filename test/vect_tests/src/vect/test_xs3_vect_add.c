...
TEST_GROUP_RUNNER(xs3_vect_add) {
  RUN_TEST_CASE(xs3_vect_add, xs3_vect_s32_add_prepare);
  RUN_TEST_CASE(xs3_vect_add, xs3_vect_s16_add_basic);
  RUN_TEST_CASE(xs3_vect_add, xs3_vect_s16_add_random);
  RUN_TEST_CASE(xs3_vect_add, xs3_vect_s32_add_basic);
  RUN_TEST_CASE(xs3_vect_add, xs3_vect_s32_add_random);
}
...
TEST(xs3_vect_add, xs3_vect_s16_add_basic)
{
...
TEST(xs3_vect_add, xs3_vect_s16_add_random)
{
...
TEST(xs3_vect_add, xs3_vect_s32_add_basic)
{
...
TEST(xs3_vect_add, xs3_vect_s32_add_random)
{
