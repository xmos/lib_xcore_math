...
TEST_SETUP(xs3_fft_dit) { fflush(stdout); }
...
{
#define FUNC_NAME "xs3_fft_dit_forward_complete"
...
{
#define FUNC_NAME "xs3_fft_dit_inverse_complete"
...
{
#define FUNC_NAME "xs3_fft_dit_forward"
...
{
#define FUNC_NAME "xs3_fft_dit_inverse"
