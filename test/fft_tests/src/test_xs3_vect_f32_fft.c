...
TEST_GROUP_RUNNER(xs3_vect_f32_fft) {
  RUN_TEST_CASE(xs3_vect_f32_fft, xs3_vect_f32_fft_forward);
  RUN_TEST_CASE(xs3_vect_f32_fft, xs3_vect_f32_fft_inverse);
}

TEST_GROUP(xs3_vect_f32_fft);
TEST_SETUP(xs3_vect_f32_fft) { fflush(stdout); }
TEST_TEAR_DOWN(xs3_vect_f32_fft) {}
...
TEST(xs3_vect_f32_fft, xs3_vect_f32_fft_forward)
{
#define FUNC_NAME "xs3_vect_f32_fft_forward"
...
TEST(xs3_vect_f32_fft, xs3_vect_f32_fft_inverse)
{
#define FUNC_NAME "xs3_vect_f32_fft_inverse"
