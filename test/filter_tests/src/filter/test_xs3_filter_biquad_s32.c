...
void test_xs3_filter_biquad_s32_case0()
{
    PRINTF("%s...\n", __func__);
...
void test_xs3_filter_biquad_s32_case1()
{
    PRINTF("%s...\n", __func__);
...
void test_xs3_filter_biquad_s32_case2()
{
    PRINTF("%s...\n", __func__);
...
void test_xs3_filter_biquad_s32_case3()
{
    PRINTF("%s...\n", __func__);
...
void test_xs3_filter_biquad_s32()
{
    SET_TEST_FILE();

    RUN_TEST(test_xs3_filter_biquad_s32_case0);
    RUN_TEST(test_xs3_filter_biquad_s32_case1);
    RUN_TEST(test_xs3_filter_biquad_s32_case2);
    RUN_TEST(test_xs3_filter_biquad_s32_case3);
