...
static void test_bfp_s16_add_0()
{
    PRINTF("%s...\n", __func__);
    ...
    bfp_s16_init(&A, dataA, 0, MAX_LEN, 0);
    bfp_s16_init(&B, dataB, 0, MAX_LEN, 0);
    bfp_s16_init(&C, dataC, 0, MAX_LEN, 0);
    ...
    for(int v = start_case; v < N_cases; v++){
        ...
        bfp_s16_set(&B, casse->b.value, casse->b.exp);
        bfp_s16_set(&C, casse->c.value, casse->c.exp);
...
static void test_bfp_s16_add_1()
{
...
static void test_bfp_s32_add_0()
{
    PRINTF("%s...\n", __func__);
    ...
    bfp_s32_init(&A, dataA, 0, MAX_LEN, 0);
    bfp_s32_init(&B, dataB, 0, MAX_LEN, 0);
    bfp_s32_init(&C, dataC, 0, MAX_LEN, 0);
    ...
    for(int v = start_case; v < N_cases; v++){
        ...
        bfp_s32_set(&B, casse->b.value, casse->b.exp);
        bfp_s32_set(&C, casse->c.value, casse->c.exp);
...
static void test_bfp_s32_add_1()
{
    PRINTF("%s...\t(random vectors)\n", __func__);
...
static void test_bfp_s16_sub_0()
{
    PRINTF("%s...\n", __func__);
...
static void test_bfp_s16_sub_1()
{
    PRINTF("%s...\t(random vectors)\n", __func__);
...
static void test_bfp_s32_sub_0()
{
    PRINTF("%s...\n", __func__);
...
static void test_bfp_s32_sub_1()
{
    PRINTF("%s...\t(random vectors)\n", __func__);
...
void test_bfp_add_sub_vect()
{
    ...
    RUN_TEST(test_bfp_s16_add_0);
    RUN_TEST(test_bfp_s16_add_1);

    RUN_TEST(test_bfp_s32_add_0);
    RUN_TEST(test_bfp_s32_add_1);
    
    
    RUN_TEST(test_bfp_s16_sub_0);
    RUN_TEST(test_bfp_s16_sub_1);

    RUN_TEST(test_bfp_s32_sub_0);
    RUN_TEST(test_bfp_s32_sub_1);
}