...
static void test_xs3_cls_array_s16_case0()
{
    typedef struct {
        int16_t value;
        headroom_t exp_hr;
    ...
    for(int v = 0; v < N_cases; v++){
        ...
        headroom_t hr = xs3_cls_array_s16(A, 1);
...
#define LEN     64
#define REPS    100
static void test_xs3_cls_array_s16_case1()
{
    seed = 362546234;
    ...
    for(int v = 0; v < REPS; v++){
        ...
        headroom_t hr = xs3_cls_array_s16(A, LEN);
...
static void test_xs3_cls_array_s32_case0()
{
    typedef struct {
        int32_t value;
        headroom_t exp_hr;
    ...
    for(int v = 0; v < N_cases; v++){
        ...
        headroom_t hr = xs3_cls_array_s32(A, 1);
...
#define LEN     64
#define REPS    100
static void test_xs3_cls_array_s32_case1()
{
    seed = 362546234;
    ...
    for(int v = 0; v < REPS; v++){
        ...
        headroom_t hr = xs3_cls_array_s32(A, LEN);
...
int test_xs3_cls_array()
{
    ...
    RUN(test_xs3_cls_array_s16_case0);
    RUN(test_xs3_cls_array_s16_case1);
    
    RUN(test_xs3_cls_array_s32_case0);
    RUN(test_xs3_cls_array_s32_case1);
