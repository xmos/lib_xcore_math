...
static void test_xs3_complex_mul_vect_complex_s16_basic()
{
    PRINTF("%s...\n", __func__);
    ...
    for(int v = start_case; v < N_cases; v++){
        ...
        for( int l = 0; l < sizeof(lengths)/sizeof(lengths[0]); l++){
            ...
            hr = xs3_complex_mul_vect_complex_s16(A.real, A.imag, 
                                                  B.real, B.imag, 
                                                  C.real, C.imag, 
                                                  len, casse->sat);
...
static void test_xs3_complex_mul_vect_complex_s16_random()
{
    PRINTF("%s...\n", __func__);
    seed = 0xAD04D98D;
...
static void test_xs3_complex_mul_vect_complex_s32_basic()
{
    PRINTF("%s...\n", __func__);
    ...
    for(int v = start_case; v < N_cases; v++){
        ...
        for( int l = 0; l < sizeof(lengths)/sizeof(lengths[0]); l++){
            ...
            hr = xs3_complex_mul_vect_complex_s32(A, B, C, len, casse->shr.b, casse->shr.c);
            ...
            memcpy(A, B, sizeof(A));
            hr = xs3_complex_mul_vect_complex_s32(A, A, C, len, casse->shr.b, casse->shr.c);
            ...
            memcpy(A, C, sizeof(A));
            hr = xs3_complex_mul_vect_complex_s32(A, B, A, len, casse->shr.b, casse->shr.c);
...
#define MAX_LEN     100
#define REPS        IF_QUICK_TEST(100, 100)
static void test_xs3_complex_mul_vect_complex_s32_random()
{
    PRINTF("%s...\n", __func__);
    seed = 0xAD04D98D;
    ...
    for(int v = 0; v < REPS; v++){
        ...
        hr = xs3_complex_mul_vect_complex_s32(A, B, C, len, b_shr, c_shr);
        ...
        memcpy(&A, &B, sizeof(A));
        hr = xs3_complex_mul_vect_complex_s32(A, A, C, len, b_shr, c_shr);
        ...
        memcpy(&A, &C, sizeof(A));
        hr = xs3_complex_mul_vect_complex_s32(A, B, A, len, b_shr, c_shr);
...
void test_xs3_complex_mul_vect_complex()
{
    ...
    RUN_TEST(test_xs3_complex_mul_vect_complex_s32_basic);
    RUN_TEST(test_xs3_complex_mul_vect_complex_s32_random);
}