...
void test_xs3_argmin_s16_random()
{
    PRINTF("%s...\n", __func__);
    seed = 0x6D734F1E;
...
#define MAX_LEN     200
#define REPS        IF_QUICK_TEST(10, 400)
void test_xs3_argmin_s32_random()
{
    PRINTF("%s...\n", __func__);
    seed = 346332123;
...
void test_xs3_argmin()
{
    SET_TEST_FILE();

    RUN_TEST(test_xs3_argmin_s16_random);
    RUN_TEST(test_xs3_argmin_s32_random);
}