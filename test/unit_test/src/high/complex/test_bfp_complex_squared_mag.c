...
void test_bfp_vect_complex_s16_squared_mag()
{
    PRINTF("%s...\n", __func__);
    ...
    for(int r = 0; r < REPS; r++){
        ...
        bfp_vect_complex_s16_squared_mag(&A, &B);
...
void test_bfp_vect_complex_s32_squared_mag()
{
    PRINTF("%s...\n", __func__);
    ...
    for(int r = 0; r < REPS; r++){
        ...
        bfp_vect_complex_s32_squared_mag(&A, &B);
...
void test_bfp_squared_mag_vect_complex()
{
    ...
    RUN_TEST(test_bfp_vect_complex_s16_squared_mag);
    RUN_TEST(test_bfp_vect_complex_s32_squared_mag);
}