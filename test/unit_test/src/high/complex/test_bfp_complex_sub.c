...
static void test_bfp_vect_complex_s16_sub()
{
    PRINTF("%s...\n", __func__);
    ...
    for(int r = 0; r < REPS; r++){
        ...
        bfp_vect_complex_s16_sub(&A, &B, &C);
...
static void test_bfp_vect_complex_s32_sub()
{
    PRINTF("%s...\n", __func__);
    ...
    for(int r = 0; r < REPS; r++){
        ...
        bfp_vect_complex_s32_sub(&A, &B, &C);
...
void test_bfp_sub_vect_complex()
{
    ...
    RUN_TEST(test_bfp_vect_complex_s16_sub);
    RUN_TEST(test_bfp_vect_complex_s32_sub);
}