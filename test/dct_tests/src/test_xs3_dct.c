...
TEST_GROUP_RUNNER(xs3_vect_s32_dct) {
  RUN_TEST_CASE(xs3_vect_s32_dct, dct6_forward);
  RUN_TEST_CASE(xs3_vect_s32_dct, dct8_forward);
  RUN_TEST_CASE(xs3_vect_s32_dct, dct12_forward);
  RUN_TEST_CASE(xs3_vect_s32_dct, dct16_forward);
  RUN_TEST_CASE(xs3_vect_s32_dct, dct24_forward);
  RUN_TEST_CASE(xs3_vect_s32_dct, dct32_forward);
  RUN_TEST_CASE(xs3_vect_s32_dct, dct48_forward);
  RUN_TEST_CASE(xs3_vect_s32_dct, dct64_forward);
}

TEST_GROUP(xs3_vect_s32_dct);
TEST_SETUP(xs3_vect_s32_dct) { fflush(stdout); }
TEST_TEAR_DOWN(xs3_vect_s32_dct) {}
...
TEST(xs3_vect_s32_dct, dct6_forward)
{
...
TEST(xs3_vect_s32_dct, dct8_forward)
{
...
TEST(xs3_vect_s32_dct, dct12_forward)
{
...
TEST(xs3_vect_s32_dct, dct16_forward)
{
...
TEST(xs3_vect_s32_dct, dct24_forward)
{
...
TEST(xs3_vect_s32_dct, dct32_forward)
{
...
TEST(xs3_vect_s32_dct, dct48_forward)
{
...
TEST(xs3_vect_s32_dct, dct64_forward)
{
