...
TEST_GROUP_RUNNER(xs3_idct) {
  RUN_TEST_CASE(xs3_idct, dct6_inverse);
  RUN_TEST_CASE(xs3_idct, dct8_inverse);
  RUN_TEST_CASE(xs3_idct, dct12_inverse);
  RUN_TEST_CASE(xs3_idct, dct16_inverse);
  RUN_TEST_CASE(xs3_idct, dct24_inverse);
  RUN_TEST_CASE(xs3_idct, dct32_inverse);
  RUN_TEST_CASE(xs3_idct, dct48_inverse);
  RUN_TEST_CASE(xs3_idct, dct64_inverse);
}

TEST_GROUP(xs3_idct);
TEST_SETUP(xs3_idct) { fflush(stdout); }
TEST_TEAR_DOWN(xs3_idct) {}
